...
const Service = () => {
  return (
    <div className="container mx-auto lg:grid lg:grid-cols-8 gap-6 py-24 px-12 items-center place-content-center justify-center">
      <div className="col-span-2 flex flex-col my-6 items-center justify-center text-center">
        <FaEnvira className="w-16 h-16 text-amber-600 bg-gray-100 rounded-full p-1" />
        <p className="py-4 text-2xl font-medium text-gray-600">معماری خیره‌کننده</p>
      ...
      <div className="col-span-2 flex flex-col my-6 items-center justify-center text-center">
        ...
        <p className="py-4 text-2xl font-medium text-gray-600">تخصص و دقت در اجرا</p>
        <p className="text-gray-600">
      ...
      <div className="col-span-2 flex flex-col my-6 items-center justify-center text-center">
        ...
        <p className="py-4 text-2xl font-medium text-gray-600">راه‌حل‌های پایدار</p>
        <p className="text-gray-600">
      ...
      <div className="col-span-2 flex flex-col my-6 items-center justify-center text-center">
        ...
        <p className="py-4 text-2xl font-medium text-gray-600">رویکرد مشتری‌محور</p>
        <p className="text-gray-600">
