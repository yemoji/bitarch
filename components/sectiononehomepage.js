      ...
      <div className="lg:grid lg:grid-cols-2 px-12">
        <div className="col-span-1 space-y-6 py-12 text-center px-8">
          ...
          <p className="text-xl font-light text-gray-500">
            بیتا زارع، در سال 1393 گروه معماری بیتا آرک را تاسیس کرد. حاصل این
            دوره فعالیت، طراحی پروژه های معماری با کاربری‌های مختلف در مقیاسهای
            کوچک و بزرگ بوده است. این گروه امیدوار است از طریق مطالعه و بررسی
            معماری گذشته ایران و تاکید بر معماری زمین مدار و مرتبط با مکان، به
            بیانی معاصر برای معماری خود دست یابد.
          </p>
          <Link href="/aboutus">
            <button
              type="button"
